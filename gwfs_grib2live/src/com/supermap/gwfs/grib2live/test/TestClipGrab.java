...
import com.supermap.gwfs.grib2live.util.TimeUtil;

public class TestClipGrab {
	public static void main(String[] args) {
		long lStart = System.currentTimeMillis();

//		new Grib2ConvertThread("C:\\Users\\LQ\\Desktop\\Z_NWGD_C_BABJ_20170207010106_P_RFFC_SCMOC-TMAX_201702070800_00000.GRB2").run();
		
//		new Grib2ConvertThread("C:\\Users\\LQ\\Desktop\\Z_NWGD_C_BABJ_20170204201156_P_RFFC_SCMOC-TMAX_201702050800_24024.GRB2").run();
...
//		new Grib2ConvertThread("E:/data/EN_grads_data/origin/TMP/20161225/08/Z_NWGD_C_BABJ_20161224201325_P_RFFC_SCMOC-TMP_201612250800_24003.GRB2").run();
		 File[] gribFiles = searchFile(new File("E:/data/EN_grads_data/origin/TMP"));
